...
public class Wick extends Unit {
    private static final UnitType type = UnitType.WICK;
    ...
    private enum Level {
        ...
        Level1(1, new Stats(150, 20, 5, 4), null),
        Level2(2, new Stats(160, 25, 10, 4), new Item[]{new Item(GameResource.KNOWLEDGE, 25), new Item(GameResource.IRON, 30), new Item(GameResource.URANIUM, 5)}),
        Level3(3, new Stats(170, 30, 15, 5), new Item[]{new Item(GameResource.KNOWLEDGE, 35), new Item(GameResource.IRON, 45), new Item(GameResource.URANIUM, 6)});
